...
export default function Header () {
    return(
        ...
        <header className="bg-neutral-800 text-white p-4 text-lg pt-8 ">
            <nav className="flex justify-between items-center lg:px-20 px-10">
                ...
                <svg className="w-40 mb-2 absolute left-1/2 transform -translate-x-1/2"
